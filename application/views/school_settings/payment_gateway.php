		...
		<section class="panel">
			<div class="tabs-custom">
				<ul class="nav nav-tabs">
					...
					<li>
						<a href="#RedPay" data-toggle="tab">RedPay</a>
					</li>
                ...
                <!--RedPay-->
                <div class="tab-pane box" id="RedPay">
						<?php echo form_open('settings/redpay', array('class' => 'form-horizontal frm-submit-msg'));?>
							<input type="hidden" name="branch_id" value="<?=$branch_id?>">
							<div class="form-group">
							  <label  class="col-sm-3 control-label">RedPay User Name</label>
								<div class="col-md-6">
									<input type="text" class="form-control" name="redpay_username" value="<?=$config['redpay_username']?>">
									<span class="error"></span>
								</div>
							</div>
							<div class="form-group">
								<label  class="col-sm-3 control-label">RedPay Password</label>
								<div class="col-md-6">
									<input type="text" class="form-control" name="redpay_password" value="<?=$config['redpay_password']?>">
									<span class="error"></span>
								</div>
							</div>
							<div class="form-group">
								<label  class="col-sm-3 control-label">RedPay Api</label>
								<div class="col-md-6">
									<input type="text" class="form-control" name="redpay_api" value="<?=$config['redpay_api']?>">
									<span class="error"></span>
								</div>
							</div>
			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-md-12">
						<div class="checkbox-replace">
							<label class="i-checks">
								<input type="checkbox" name="redpay_status" id="redpay_status" <?=($config['redpay_status'] == 1 ? 'checked' : ''); ?>>
								<i></i> RedPay
							</label>
						</div>
					</div>
