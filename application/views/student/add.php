		...
		<section class="panel">
			...
			<div class="panel-body">
				...
				<div class="row">
					...
					<?php
					if($this->app_lib->getTable('control_student_form', "field_label='gender'", true)['status'] != 0):
					?>
					<div class="col-md-4 mb-sm">
						<div class="form-group">
				...
				<div class="row">
					<?php
					if($this->app_lib->getTable('control_student_form', "field_label='blood_group'", true)['status'] != 0):
					?>
					...
					<?php endif;
					if($this->app_lib->getTable('control_student_form', "field_label='date_of_birth'", true)['status'] != 0):
					?>
					<div class="col-md-6 mb-sm">
						<div class="form-group">
				...
				<div class="row">
					<?php
					if($this->app_lib->getTable('control_student_form', "field_label='mother_tongue'", true)['status'] != 0):
					?>
					<div class="col-md-4 mb-sm">
						<div class="form-group">
					...
					<?php endif;
					if($this->app_lib->getTable('control_student_form', "field_label='religion'", true)['status'] != 0):
					?>
					<div class="col-md-4 mb-sm">
						<div class="form-group">
					...
					<?php endif;
					if($this->app_lib->getTable('control_student_form', "field_label='caste'", true)['status'] != 0):
					?>
					<div class="col-md-4 mb-sm">
						<div class="form-group">
				...
				<div class="row">
					...
					<?php
					if($this->app_lib->getTable('control_student_form', "field_label='email'", true)['status'] != 0):
					?>
					<div class="col-md-3 mb-sm">
						<div class="form-group">
					...
					<?php endif;
					if($this->app_lib->getTable('control_student_form', "field_label='city'", true)['status'] != 0):
					?>
					<div class="col-md-3 mb-sm">
						<div class="form-group">
					...
					<?php endif;
					if($this->app_lib->getTable('control_student_form', "field_label='state'", true)['status'] != 0):
					?>
					<div class="col-md-3 mb-sm">
						<div class="form-group">
				...
				<div class="row">
					<?php
					if($this->app_lib->getTable('control_student_form', "field_label='present_address'", true)['status'] != 0):
					?>
					<div class="col-md-6 mb-sm">
						<div class="form-group">
					...
					<?php endif;
					if($this->app_lib->getTable('control_student_form', "field_label='permanent_address'", true)['status'] != 0):
					?>
					<div class="col-md-6 mb-sm">
						<div class="form-group">
				...
				<div class="row">
					<?php
					if($this->app_lib->getTable('control_student_form', "field_label='profile_picture'", true)['status'] != 0):
					?>
				...
				<?php
				if($this->app_lib->getTable('control_student_form', "field_label='guardian_already_exist'", true)['status'] != 0):
				?>
				...
				<div id="guardian_form" <?php if(set_value('guardian_chk') == true) echo 'style="display: none;"'; ?>>
					<div class="row">
						<?php
						if($this->app_lib->getTable('control_student_form', "field_label='guardian_name'", true)['status'] != 0):
						?>
						<div class="col-md-6 mb-sm">
							<div class="form-group">
						...
						if($this->app_lib->getTable('control_student_form', "field_label='relation'", true)['status'] != 0):
						?>
						<div class="col-md-6 mb-sm">
							<div class="form-group">
					...
					<div class="row">
						<?php
						if($this->app_lib->getTable('control_student_form', "field_label='father_name'", true)['status'] != 0):
						?>
						<div class="col-md-6 mb-sm">
							<div class="form-group">
						...
						if($this->app_lib->getTable('control_student_form', "field_label='mother_name'", true)['status'] != 0):
						?>
						<div class="col-md-6 mb-sm">
							<div class="form-group">
					...
					<div class="row">
						<?php 
						if($this->app_lib->getTable('control_student_form', "field_label='occupation'", true)['status'] != 0):
						?>
						<div class="col-md-4 mb-sm">
							<div class="form-group">
						...
						if($this->app_lib->getTable('control_student_form', "field_label='income'", true)['status'] != 0):
						?>
						<div class="col-md-4 mb-sm">
							<div class="form-group">
						...
						if($this->app_lib->getTable('control_student_form', "field_label='guardian_education'", true)['status'] != 0):
						?>
						<div class="col-md-4 mb-sm">
							<div class="form-group">
					...
					<div class="row">
						<?php
						if($this->app_lib->getTable('control_student_form', "field_label='guardian_city'", true)['status'] != 0):
						?>
						<div class="col-md-3 mb-sm">
							<div class="form-group">
								<label class="control-label"><?=translate('city')?></label>
						...
						if($this->app_lib->getTable('control_student_form', "field_label='guardian_state'", true)['status'] != 0):
						?>
						<div class="col-md-3 mb-sm">
							<div class="form-group">
								<label class="control-label"><?=translate('state')?></label>
						...
						if($this->app_lib->getTable('control_student_form', "field_label='guardian_mobile_no'", true)['status'] != 0):
						?>
						<div class="col-md-3 mb-sm">
							<div class="form-group">
								<label class="control-label"><?=translate('mobile_no')?> <span class="required">*</span></label>
						...
						if($this->app_lib->getTable('control_student_form', "field_label='guardian_email'", true)['status'] != 0):
						?>
						<div class="col-md-3 mb-sm">
							<div class="form-group">
								<label class="control-label"><?=translate('email')?></label>
					...
					<div class="row">
						<?php
						if($this->app_lib->getTable('control_student_form', "field_label='address'", true)['status'] != 0):
						?>
						<div class="col-md-12 mb-sm">
							<div class="form-group">
				...
				<div class="row mb-md">
						<?php
						if($this->app_lib->getTable('control_student_form', "field_label='transport_route'", true)['status'] != 0):
						?>
					<div class="col-md-6 mb-sm">
						<div class="form-group">
						...
						if($this->app_lib->getTable('control_student_form', "field_label='vehicle_no'", true)['status'] != 0):
						?>
					<div class="col-md-6 mb-sm">
						<div class="form-group">
				...
				<div class="row mb-md">
						<?php
						if($this->app_lib->getTable('control_student_form', "field_label='hostel_name'", true)['status'] != 0):
						?>
					<div class="col-md-6 mb-sm">
						<div class="form-group">
						...
						if($this->app_lib->getTable('control_student_form', "field_label='room_name'", true)['status'] != 0):
						?>
					<div class="col-md-6 mb-sm">
						<div class="form-group">
				...
				<div class="row">
						<?php
						if($this->app_lib->getTable('control_student_form', "field_label='school_name'", true)['status'] != 0):
						?>
					<div class="col-md-6 mb-sm">
						<div class="form-group">
						...
						if($this->app_lib->getTable('control_student_form', "field_label='qualification'", true)['status'] != 0):
						?>
					<div class="col-md-6 mb-sm">
						<div class="form-group">
				...
				<div class="row mb-lg">
						<?php
						if($this->app_lib->getTable('control_student_form', "field_label='remarks'", true)['status'] != 0):
						?>
					<div class="col-md-12">
						<div class="form-group">
