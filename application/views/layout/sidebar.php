        ...
        <div class="nano-content">
            <nav id="menu" class="nav-main" role="navigation">
                <ul class="nav nav-main">
                    ...
                    <?php } ?>
                    <?php 
                    if($this->app_lib->gettable('modules', "module_name='branch' AND module_type='system'", true)['status'] == 1){
                    ...
                    <?php
                    if($this->app_lib->gettable('modules', "module_name='frontend' AND module_type='system'", true)['status'] == 1){
                    ...
                    <?php
                    if($this->app_lib->gettable('modules', "module_name='admission' AND module_type='system'", true)['status'] == 1){
                    ...
                    <li class="nav-parent <?php if ($main_menu == 'admission') echo 'nav-expanded nav-active';?>">
                        ...
                        <?php } if(get_permission('multi_class_student', 'is_view')){ ?>
                            <li class="<?php if ($sub_page == 'multi_class_student/index') echo 'nav-active';?>">
                                <a href="<?=base_url('multi_class_student/index')?>">
                                    <span><i class="fas fa-caret-right" aria-hidden="true"></i><?=translate('multi_class_student')?></span>
                                </a>
                            </li>
                    ...
                    <?php
                    if($this->app_lib->gettable('modules', "module_name='student_details' AND module_type='system'", true)['status'] == 1){
                    ...
                    <?php } } ?>
                    <?php
                    if($this->app_lib->gettable('modules', "module_name='parents' AND module_type='system'", true)['status'] == 1){
                    ...
                    <?php } } ?>
                    <?php
                    if($this->app_lib->gettable('modules', "module_name='employee' AND module_type='system'", true)['status'] == 1){
                    ...
                    <?php
                    if($this->app_lib->gettable('modules', "module_name='card_management' AND module_type='system'", true)['status'] == 1){
                    ...
                    <?php
                    if($this->app_lib->gettable('modules', "module_name='certificate' AND module_type='system'", true)['status'] == 1){
                    ...
                    <?php
                    if($this->app_lib->gettable('modules', "module_name='human_resource' AND module_type='system'", true)['status'] == 1){
                    ...
                    <?php } } ?>
                    <?php
                    if($this->app_lib->gettable('modules', "module_name='academic' AND module_type='system'", true)['status'] == 1){
                    ...
                    <?php } } ?>
                    <?php 
                    if($this->app_lib->gettable('modules', "module_name='live_class_rooms' AND module_type='system'", true)['status'] == 1){
                    ...
                    <?php } } ?>
                    <?php
                    if($this->app_lib->gettable('modules', "module_name='attachments_book' AND module_type='system'", true)['status'] == 1){
                    ...
                    <?php } } ?>
                    <?php
                    if($this->app_lib->gettable('modules', "module_name='homework' AND module_type='system'", true)['status'] == 1){
                    ...
                    <?php } } ?>
                    <?php
                    if($this->app_lib->gettable('modules', "module_name='exam_master' AND module_type='system'", true)['status'] == 1){
                    ...
                    <?php } } ?>
                    <?php
                    if($this->app_lib->gettable('modules', "module_name='supervision' AND module_type='system'", true)['status'] == 1){
                    ...
                    <?php } } ?>
                    <?php
                    if($this->app_lib->gettable('modules', "module_name='attendance' AND module_type='system'", true)['status'] == 1){
                    ...
                    <?php } } ?>
                    <?php
                    if($this->app_lib->gettable('modules', "module_name='library' AND module_type='system'", true)['status'] == 1){
                    ...
                    <?php } } ?>
                    <?php
                    if($this->app_lib->gettable('modules', "module_name='events' AND module_type='system'", true)['status'] == 1){
                    ...
                    <?php } } ?>
                    <?php
                    if($this->app_lib->gettable('modules', "module_name='bulk_sms_and_email' AND module_type='system'", true)['status'] == 1){
                    ...
                    <?php } } ?>
                    <?php
                    if($this->app_lib->gettable('modules', "module_name='student_accounting' AND module_type='system'", true)['status'] == 1){
                    ...
                    <?php } } ?>
                    <?php
                    if($this->app_lib->gettable('modules', "module_name='office_accounting' AND module_type='system'", true)['status'] == 1){
                    ...
                    <!-- message -->
                    <?php 
                    if($this->app_lib->gettable('modules', "module_name='message' AND module_type='system'", true)['status'] == 1){ ?>
                    ...
                    <li class="nav-parent <?php if ($main_menu == 'settings' || $main_menu == 'school_m') echo 'nav-expanded nav-active';?>">
                        ...
                        <ul class="nav nav-children">
                            ...
                            <?php } if(get_permission('modules', 'is_view')){ ?>
                            ...
                            <?php } if(get_permission('control_student_form', 'is_view')){ ?>
                            <li class="<?php if ($sub_page == 'control_student_form/index') echo 'nav-active';?>">
                                <a href="<?=base_url('control_student_form')?>">
                                    <span><i class="fas fa-caret-right" aria-hidden="true"></i><?=translate('control_student_form')?></span>
                                </a>
                            </li>
