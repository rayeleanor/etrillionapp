...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-map-o"></i> <?=translate('chat') ?>
        </h1>
    </section>
            ...
            <div class="col-md-12">
                ...
                <div id="frame">
                    ...
                    <div id="sidepanel">
                        ...
                        <div id="search">
                            <label for=""><?=translate('chat') . " " . translate('system') ?></label>  
                            <div id="bottom-bar">
                    ...
                    <div class="chatcontent">
                        <div class="contact-profile">
                            ...
                            <p><?=translate('select_any_user_to_start_your_chat') ?></p>
                        ...
                        <div class="message-input ">
                            <div class="wrap relative">
                                <input type="text" placeholder="<?=translate('write_your_message'); ?>..." class="chat_input" />
...
<div id="myModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <!-- Modal content-->
        <form id="addUser" action="<?php echo site_url('chat/adduser') ?>" method="POST">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title"><?=translate('add') . " " . translate('contact'); ?><small style="color:red;"> *</small></h4>
                </div>
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-success btn-sm"  data-loading-text="<i class='fa fa-spinner fa-spin '></i> Please wait"><i class="fa fa-plus"></i> <?=translate('add'); ?></button>
                </div>
            </div>
        </form>
    </div>
...
<script>
    ...
    $(document).on('click', '.contact', function () {
        ...
        $.ajax({
            type: "POST",
            url: base_url + 'chat/getChatRecord',
    ...
    function getChatNotification() {
        $.ajax({
            type: "POST",
            url: base_url + 'chat/mychatnotification',
            data: {},
            dataType: "JSON",
            beforeSend: function () {
